...
class Auth extends CI_Controller {
	...
	public function register(){
	    ...
	    $this->form_validation->set_rules('repeat_password','Repeat_password','required|trim|matches[password]');
		...
		$this->load->view('include/auth_footer');
	    	...
	    	$this->session->set_flashdata('message','<div class="alert-success" role="alert"> Congratulation! your account has been created!');
	    	redirect('auth');
